...
('3', 'Salum', 'Kambaya', '0000-00-00', 255657460201, 'kambaya@gmail.com', 'Mwanza', 'Male', 'Mwanza', 'Tanzania', '', 'me.jpg', 7),
('ANA001', 'Anna', 'Makinda', '2008-02-05', 255626394449, 'Anna@gmail.com', '12 Boma Road', 'Female', 'Morogoro', 'Tanzania', 'Married', 'img_20210702_175127.jpg', 7);
...
(26, '2020-07-27', '2020-07-30', 'tanga', 'mheza', '', 'Approved', '2021-07-09 18:42:54', '', '', '2021-07-09 18:42:54', 1, 1, '3'),
(28, '2020-07-28', '2020-07-28', 'tanga', 'mheza', '', 'Not Approved', '2020-07-27 09:52:54', '', 'Not Good', '2020-07-27 09:52:54', 1, 3, '3'),
(29, '2020-07-30', '2020-07-31', 'tanga', 'mheza', '', 'Approved', '2021-07-14 12:40:05', '2020-07-27 04:31:06', '', '2021-07-14 12:40:05', 1, 3, '3'),
(30, '2020-07-28', '2020-07-31', 'tanga', 'mheza', '', 'Approved', '2020-07-27 08:27:50', 'online biology form 4.pdf', 'test', '2020-07-27 08:27:50', 1, 2, '3'),
(32, '2021-07-12', '2021-09-09', 'Morogoro', 'Mwanza', '', 'Approved', '2021-07-15 14:09:11', 'Supportive document.pdf', 'Good Luck', '2021-07-10 11:27:44', 2, 1, 'ANA001'),
(33, '2021-07-10', '2021-10-05', 'Morogoro', 'Mwanza', '', 'Not Approved', '2021-07-10 11:29:48', 'Video provides a powerful way to help you prove your point.pdf', '', '2021-07-10 11:29:48', 1, 1, 'ANA001');
...
CREATE TABLE `leave_type` (
  ...
  `type_category` mediumtext DEFAULT NULL,
...
(23, '', 'Public', '2021-07-09 18:42:54'),
(24, '120000', 'Private', '2020-07-27 09:52:54'),
(26, '', 'Public', '2020-07-27 08:27:50'),
(29, '', 'Private', '2021-07-10 11:29:48');
...
(2, 'kambaya@gmail.com', '$2y$10$ypgFKGxHD6IWrDJDKyrDeu7ALYZ0b/3SmN8.5mNDVtOfr8rzyIIg.', '', '', 'admin', 'Active', '3'),
(30, 'Anna@gmail.com', '$2y$10$LQU7i3i4pngsspAnUshPhurvdDQX8D9sBakSgBhtdb0BRRM0dEZzq', 'RS', 'IT', 'User', 'Active', 'ANA001');
...
--
ALTER TABLE `leave_history`
  MODIFY `leave_history` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `transport`
  MODIFY `transport_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `leave_history`
  ADD CONSTRAINT `leave_history_ibfk_1` FOREIGN KEY (`employee_ID`) REFERENCES `employee` (`employee_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
